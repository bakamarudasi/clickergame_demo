...
func _clear_scope_visuals() -> void:
	...
	portrait_view.material = null
	scope_window.set_overlay_material(null)
...
func _apply_scope_resolution(scope: ScopeData) -> void:
	...
	if scope.is_inverse:
		portrait_view.material = _scope_mosaic_mat
		scope_window.set_overlay_material(null)
	else:
		portrait_view.material = null
		scope_window.set_overlay_material(_scope_mosaic_mat)
